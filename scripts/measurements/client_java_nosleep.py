...
if __name__ == "__main__":
    ...
    # Start Java server
    subprocess.Popen(["java", "-cp", str(REPO_ROOT / "benchmarks/java"), "SimpleServer"])
    ...
    with open(REPO_ROOT / 'results/benchmark_outputs/java_output_nosleep.csv', 'a', newline='') as csv_file:
